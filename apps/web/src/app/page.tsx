...
import { Zap, Shield, BarChart3, Github, Sparkles, GitBranch, Eye } from 'lucide-react'
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      >
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <Link href="/dashboard">
              <button className="px-4 py-2 text-white/70 hover:text-white hover:bg-white/[0.06] transition-colors">
                Dashboard
              </button>
            </Link>
            <HeaderSignIn />
      ...
      <main className="relative z-10 container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto min-h-screen flex flex-col justify-center py-32 border-t border-white/[0.06]">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold">From URL to Insights</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-14 h-14 bg-white/[0.03] border border-white/[0.08] flex items-center justify-center mx-auto mb-4">
...
function FeatureCard({ 
  ...
  return (
    ...
    >
      <div className="w-14 h-14 bg-lime-400/10 flex items-center justify-center mb-6 group-hover:bg-lime-400/20 transition-colors">
